...
if __name__ == "__main__":
    ...
    pipeline_benchmark(output_dir="benchmarks/llama3.1_70b_prefill", pipelines=prefill_pipelines(), device_index=DEVICE, link_model=LINK, transfer_curve=CURVE)
    pipeline_benchmark(output_dir="benchmarks/llama3.1_70b_decode",  pipelines=decode_pipelines(),  device_index=DEVICE, link_model=LINK, transfer_curve=CURVE)
